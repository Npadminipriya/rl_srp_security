...
from modification_attack import ModificationAttack
        ...
        for result in results:
            ...
            writer.writerow(
                [
                    ...
                    result["dropped_by_modification"],
...
def main() -> None:
    ...
    try:
        ...
        print(
            f"Modification probability : "
            f"{modification_probability:.0%}"
        )
            ...
            results.append(
                {
                    ...
                    "dropped_by_modification": dropped,
                    "malicious_node": (
                        malicious_node
                        if dropped
                        else ""
        ...
        dropped_packets = sum(
            1
            for result in results
            if result["dropped_by_modification"]
        )
        ...
        route_failures = sum(
            ...
            if (
                ...
                and not result["dropped_by_modification"]
            )
        )
        ...
        print("\nPacket modification attack results")
        ...
        print(
            f"  Packet modification attack observed : "
        ...
        if (
            ...
            print(
                "\nPhase 11 requires further validation."
            )
