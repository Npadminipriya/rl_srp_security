...
from selective_forwarding_attack import (
    ...
    with output_path.open(
        ...
        writer.writerow(
            [
                ...
                "rl_route_found",
                "packet_delivered",
                "dropped_by_selective_forwarding",
                "malicious_node",
                "observer_node",
                "trust_before",
                "trust_after",
        ...
        for result in results:
            ...
            writer.writerow(
                [
                    ...
                    result["dropped_by_selective_forwarding"],
...
def main() -> None:
    ...
    try:
        ...
        print("=" * 72)
        print(
            "RL-SRP PHASE 9: SELECTIVE FORWARDING ATTACK"
        )
        print("=" * 72)
        ...
        attack = SelectiveForwardingAttack(
        ...
        print(
            ...
            "under selective forwarding attack..."
        )
            ...
            results.append(
                {
                    ...
                    "dropped_by_selective_forwarding": dropped,
                    "malicious_node": (
                        malicious_node
                        if dropped
                        else ""
        ...
        dropped_packets = sum(
            1
            for result in results
            if result["dropped_by_selective_forwarding"]
        )
        ...
        route_failures = sum(
            ...
            if (
                ...
                and not result["dropped_by_selective_forwarding"]
            )
        )
        ...
        print("\nSelective forwarding attack results")
        ...
        print(
            f"  Selective forwarding observed : "
        ...
        if (
            ...
            print(
                "\nPhase 9 requires further validation."
            )
