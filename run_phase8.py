...
from attack_models import BlackholeAttack
...
def main() -> None:
    ...
    try:
        ...
        print("=" * 72)
        print(
            "RL-SRP PHASE 8: BLACKHOLE ATTACK"
        )
        print("=" * 72)
                ...
                if routing_result.delivered:
                    ...
                    for index in range(
                        ...
                        if not forwarding_success:
                            ...
                            # The trust value is already
                            # updated by process_hop().
                            trust_after = (
                                record.trust_value
                            )
                ...
                results.append(
                    {
                        ...
                        "route": route,
                        "hop_count": (
                            routing_result.hop_count
                        ),
                        "rl_route_found": (
                            routing_result.delivered
                        ),
                        "packet_delivered": (
                            packet_delivered
                        ),
        ...
        dropped_packets = sum(
            1
            for result in results
            if result["dropped_by_blackhole"]
        )
        ...
        route_failures = sum(
            ...
            if (
                ...
                and not result["dropped_by_blackhole"]
            )
        )
        ...
        if (
            ...
            print(
                "\nPhase 8 requires further validation."
            )
